...
public class SubPants extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_sub_pants, container, false);
        recyclerViewAll = view.findViewById(R.id.recyclerViewPants);

        context = view.getContext();


        AdapterPants adapterAll = new AdapterPants(context,data.list);
    ...
    class AdapterPants extends RecyclerView.Adapter<AdapterPants.MyViewHolder>{
        Context mContext;
        ArrayList<DataModel> mList;


        public AdapterPants(Context context, ArrayList<DataModel> mList) {
